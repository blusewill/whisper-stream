...
def main():
    ...
    model_questions = [
        inquirer.List('model', message='Please Choose your Whisper Model', choices=['tiny','base','small','medium','large-v1','large-v2','large']),
    ]
    ...
    english_questions = [
        inquirer.List('english', message='Do you want to use English Only Model?', choices=['yes', 'no']),
    ]
    
    # Set the Answer of Enlgish Model Only
